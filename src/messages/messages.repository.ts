...
export class MessagesRepository {
	...
	async updateOneMessage(query: Filter<Message>, update: Partial<Message> | UpdateFilter<Message>) {
	...
	async findOne(query: Filter<Message>, options: FindOptions<Message> = undefined) {
	...
	async findMany(query: Filter<Message>, options: FindOptions<Message> = undefined) {
